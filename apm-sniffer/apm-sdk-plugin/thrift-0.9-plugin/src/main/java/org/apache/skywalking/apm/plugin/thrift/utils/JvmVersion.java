...
public enum JvmVersion {
    ...
    private static final HashMap<Integer,JvmVersion> CLASS_VERSION_MAP = toClassVersionMap();
    ...
    private static HashMap<Integer,JvmVersion> toClassVersionMap() {
        final HashMap<Integer,JvmVersion>jvmVersionIntHashMap = new HashMap<Integer,JvmVersion>();
